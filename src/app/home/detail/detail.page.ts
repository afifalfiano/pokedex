...
@Component({
  ...
  standalone: true,
  imports: [IonIcon, IonButton, IonLoading, IonText, IonContent, IonImg, CommonModule, FormsModule, TitleCasePipe, PxIonHeaderComponent, PxIonToastComponent, PxIonRefresherComponent]
})
